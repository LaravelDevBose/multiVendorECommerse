...
# MERCHANT ACCOUTN DETAILS
//FINOVA01
define("SSLCZ_STORE_ID", 'mydorponlive');
//define("SSLCZ_STORE_ID", 'testbox');
define("SSLCZ_STORE_PASSWD", 'mydorponlive95049');
...
class SSLCommerz {
                ...
                if(isset($this->sslc_data['status']) && $this->sslc_data['status']=='SUCCESS') {
                    if(!$get_pay_options) {
                        if (isset($this->sslc_data['GatewayPageURL']) && $this->sslc_data['GatewayPageURL'] != '') {
                            $options['url'] =  $this->sslc_data['GatewayPageURL'];
                        } else {
                        ...
                        if(isset($this->sslc_data['gw']['visa']) &&  $this->sslc_data['gw']['visa']!=""){
                            ...
                            foreach($sslcz_visa as $gw_value) {
                                ...
                                if($gw_value=='visacard') {
                                    ...
                                    $options['cards'][5]['name'] = "URL";
                                    $options['cards'][5]['link'] = '<meta http-equiv="refresh" content="0; url='.$this->sslc_data['GatewayPageURL'].'">';
                        ...
                        # MASTER GATEWAY
                        if(false && isset($this->sslc_data['gw']['master']) &&  $this->sslc_data['gw']['master']!=""){
                        ...
                        # AMEX GATEWAY
                        if(false && isset($this->sslc_data['gw']['amex']) &&  $this->sslc_data['gw']['amex']!=""){
                        ...
                        # OTHER CARDS GATEWAY
                        if(false && isset($this->sslc_data['gw']['othercards']) &&  $this->sslc_data['gw']['othercards']!=""){
                        ...
                        if(false && isset($this->sslc_data['gw']['internetbanking']) &&  $this->sslc_data['gw']['internetbanking']!=""){
                        ...
                        if(false && isset($this->sslc_data['gw']['mobilebanking']) &&  $this->sslc_data['gw']['mobilebanking']!=""){
    ...
    public function SSLCOMMERZ_ipn_hash_varify($data="") {
        $store_passwd = $this->store_pass;
