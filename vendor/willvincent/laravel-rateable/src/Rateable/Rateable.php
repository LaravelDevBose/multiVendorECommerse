...
trait Rateable
{
    ...
    {
        return $this->ratings()->where('rateable_id', $productId)->count();
    }
...
//    public  function userProductRatingStatus($productId){
//        return $this->ratings()->where('user_id', \Auth::id())->where('rateable_id', $productId)->first();
//    }
...
//    public function getUserProductRatingStatus()
//    {
//        return $this->userProductRatingStatus();
//    }
