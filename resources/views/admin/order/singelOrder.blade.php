    ...
    <div class="panel panel-white">
      <div class="panel-heading">
        ...
        <div class="heading-elements">
          <a href="{{ route('invoice.download',['orderId'=>$orderInfo->id,'type'=>'V']) }}"  class="btn btn-info btn-sm heading-btn"><i class="icon-eye position-left"></i> Preview</a>
          <a href="{{ route('invoice.download',['orderId'=>$orderInfo->id,'type'=>'D']) }}"  class="btn btn-success btn-sm heading-btn"><i class="icon-download4 position-left"></i> Download</a>
        </div>
      </div>
