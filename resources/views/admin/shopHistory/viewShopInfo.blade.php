		...
		<div class="col-md-12">
			...
			<div class="panel panel-flat">
				<div class="panel-heading">
					<h5 class="panel-title">Shops and Artisans Details</h5>
				...
				<table class="table table-bordered datatable-complex-header">
					<thead>
						<tr>
                            <th rowspan="2">Shop Information</th>
                            <th colspan="3">Owner Details</th>
                            <th colspan="2">Product/Sell Info</th>
					...
					<tbody>
			            ...
			            <tr>
                            ...
                            <td>
                            	Tk. <?php echo $totalSell = App\OrderDetail::where('ownerId',$shopInfo->id)->sum('subTotal');?>
                            </td>
                            <td>
                            	@if($shopInfo->status == 0)
									<button title="Shop In procesing" class="btn bg-teal btn-sm"><i class="icon-hour-glass"></i></button>
                            	@elseif($shopInfo->status == 1)
                            	<a  title="Publish Shop" class="btn btn-success btn-sm"><i class="icon-checkmark4"></i></a>
                            	@else
                            	<a  title="Block Shop" class="btn btn-danger btn-sm"><i class="icon-blocked"></i></a>
                            	@endif
                        ...
                        @empty
                        	<tr>
                        		<td colspan="7">
                        			<span class="text-semibold text-info">No Shop Information Found ..!</span>
                        		</td>
                        	</tr>
