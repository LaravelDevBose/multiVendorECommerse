                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="meas_field">
                                        <tr>
                                            <td style="width:25%;"><input type="text"  name="sizeFileName[]"  placeholder="Enter Field Name" class="form-control name_list"  /></td>
                                            <td><input type="number" name="sizeData[]" step="0.01"   placeholder="Enter Field Value" class="form-control name_list"  /></td>
                                    ...
                                    <div class="col-md-12" id="copy{{ $sizeMainCat[$i] }}">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select name="mainCatId[{{$j}}]"   class="select">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="secondCatId[{{$j}}]"  data-placeholder="Select Sub Category Name"  class="select">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <select name="thirdCatId[{{$j}}]"  data-placeholder="Select 3rd Category"    class="select">
                                                    @if($checkSecCat !=0)
