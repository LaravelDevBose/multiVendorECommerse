...
@section('body')
	...
	<div class="content">
		...
		<form action="{{ route('item.update')}}" method="POST" enctype="multipart/form-data"> {{csrf_field()}}
			<div class="row">
										...
										<div class="col-md-4">
											<div class="thumbnail ">
												<div class="thumb">
													...
													<span>
														<a href="{{route('item.image.delete',$productImage->id)}}"  class="btn btn-flat btn-danger text-white btn-sm image-delete" onclick="return confirm('Are You Sure You Want to Delete This Image'); ">Delete</a>
													</span>
													</div>
												</div>
											</div>
						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-lg-6" >
									<div class="checkbox">
										<label>
											<input type="checkbox" disabled name="feature" {{ ($productById->feature == 1)?'checked': ' '  }}  value="1" class="styled">Featured Product</label>
									</div>
								</div>
								<div class="col-lg-6" >
									<div class="checkbox">
