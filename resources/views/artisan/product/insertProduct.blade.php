...
<div class="content">
	@include('admin.includes.message')
		<form action="{{ route('item.store')}}" method="POST" enctype="multipart/form-data"> {{csrf_field()}}
		<div class="row">
							...
							<div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<input type="number" value="{{ old('productWeight') }}" name="productWeight" required class="form-control maxlength-options" step="0.01"  placeholder="Insert Product Weight">
										<span class="help-block"> Product Weight (Kg)</span>
									</div>
								</div>
							</div>
							...
							<div class="row">
								...
								<div class="col-md-3">
									<div class="form-group">
			                        	...
			                        	<input type="number" value="{{ old('sellPrice') }}" class="form-control" name="sellPrice"  placeholder="Product Selling Price">
								...
								<div class="col-md-3">
									<div class="form-group">
			                        	...
			                        	<input type="text" value="{{ old('discount') }}" class="form-control" name="discount"  placeholder="Enter Discount in %">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="number" value="{{ old('finalPrice') }}" name="finalPrice" disabled class="form-control"   required placeholder="Final Price that Cunstomer Show">
								...
								<div class="col-md-3">
									<div class="form-group">
										...
										<input type="number" value="{{ old('costPrice') }}" disabled name="costPrice" class="form-control"   required placeholder="Artisan Price">
							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
                                        ...
                                        <textarea  name="shortDes" cols="3" rows="3" class="wysihtml5 wysihtml5-default form-control" placeholder="Short Description (Max 150 characters)">{{ old('shortDes') }}</textarea>
							...
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										<select multiple data-placeholder="Select Product Materials"  name="materialsIds[]" required class="select">
						...
						<div class="row">
							...
							<div class="col-md-12">
								<div class="form-group">
									...
									<textarea rows="3" cols="3" name="customeMessage"  disabled maxlength="150" class="form-control maxlength-textarea" placeholder="Write Customized Product Note">{{ old('customeMessage') }}</textarea>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header bg-success-800">
						...
						<h5 class="modal-title">Product Insert Form</h5>
					</div>

						<div class="modal-body">
							<div class="alert alert-info" role="alert">
								Are You Sure Went to Store This Product.
							</div>
						</div>
...
<script>var shopId = "{{ Auth::User()->shopId }}";</script>
